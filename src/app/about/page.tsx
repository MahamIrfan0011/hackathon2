...
export default function Home() {
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="w-full h-[84px] bg-[#F0F2F3] py-4 px-6 md:px-20 lg:px-[300px] flex justify-between items-center">
      ...
      <div className="w-full h-[74px] bg-white flex text-[#636270]">
        <ul className="ml-10 flex justify-center md:justify-start items-center space-x-4 md:space-x-8 lg:pl-40 w-full">
        ...
        <div className='hidden md:flex w-[168px] h-[15px] items-center justify-end mr-16 mt-8'>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row items-start w-full max-w-7xl mt-10">
          {/* Text Content */}
          <div className="w-full md:w-[480px] h-[370px] bg-[#007580] mx-4 p-6 lg:ml-32">
          ...
          {/* Image */}
          <div className="mx-4 mt-6 md:mt-0 md:ml-auto lg:mr-28">
            <Image
              src="/Image Block.png"
              alt="chair"
              width={480}
      ...
      <div className='w-full mt-8'>
        <h4 className='font-inter font-semibold text-[32px] text-[#272343] text-center'>
      ...
      <div className="flex flex-col h-screen mt-72 ml-4 md:ml-16">
        {/* Main Content */}
